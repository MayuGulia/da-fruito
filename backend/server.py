...
SEED_HAMPERS = [
    {"name": "The Everlasting Bonds", "occasion": "anniversary", "price": 7800, "image": "https://images.unsplash.com/photo-1608142737432-b0a0bed6fdee?w=1200&q=80", "description": "A ceremony in a ceramic vessel. Single-origin chocolates, first-flush tea, and a handwritten note.", "materials": ["Ceramic", "Silk Ribbon"], "items": ["Belgian Dark Truffles", "Darjeeling First Flush", "Acacia Wildflower Honey"]},
