...
export const Contact = () => {
  ...
  return (
    <section id="contact" data-testid="contact-section" className="py-24 md:py-32 bg-[#EEF5F4]">
      <div className="lux-container text-center max-w-3xl">
        <Reveal>
          <div className="text-[0.7rem] tracking-[0.4em] text-[#2A7E7C] uppercase font-ui mb-3">Reach Us</div>
          <h2 className="font-display text-5xl md:text-6xl text-[#1A2E2E]">A Question? A <em className="italic text-[#2A7E7C]">Special Request?</em></h2>
          <p className="font-body italic text-[#3D5C5A] mt-5 text-lg">Our team is one message away.</p>
          <a
