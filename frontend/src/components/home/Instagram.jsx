...
export const InstagramStrip = () => (
  <section data-testid="instagram-strip" className="py-20 overflow-hidden bg-obsidian">
    <Reveal>
      <div className="text-center mb-10">
        <div className="text-[0.7rem] tracking-[0.4em] text-bronze uppercase font-ui mb-3">The Atelier</div>
        <h2 className="font-display text-4xl md:text-6xl text-ivory">The Art, As It <em className="text-antique italic">Leaves Our Hands</em></h2>
      </div>
    </Reveal>
    <div className="relative w-full overflow-hidden">
      <div className="flex gap-4 w-[200%] animate-marquee" style={{ willChange: "transform" }}>
        {STRIP.map((src, i) => (
          <a key={i} href="https://instagram.com" target="_blank" rel="noreferrer" className="relative shrink-0 w-60 h-60 overflow-hidden group">
            ...
            <div className="absolute inset-0 bg-obsidian/70 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center">
