  ...
  return (
    <section data-testid="hero-section" className="relative h-[100vh] overflow-hidden vignette">
      <motion.img
        ...
        style={{ y, scale: 1.12 }}
      />
      <div className="absolute inset-0 bg-[#FDFAF6]/30" />
      <motion.div style={{ opacity }} className="relative z-10 h-full flex flex-col items-center justify-center text-center px-4 max-w-5xl mx-auto">
        <motion.div
          ...
          className="font-ui text-[0.65rem] md:text-[0.75rem] text-[#B07D62] uppercase mb-6 drop-shadow-[0_2px_8px_rgba(253,250,246,0.9)]"
        >
        ...
        <motion.h1
          ...
          className="font-display italic text-[11vw] md:text-[6vw] leading-[1.05] text-[#2D2420] drop-shadow-[0_3px_16px_rgba(253,250,246,0.85)]"
        >
          The Art of Gifting,<br /><span className="text-[#B07D62]">Perfected.</span>
        </motion.h1>
        <motion.p
          initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.9, delay: 0.9 }}
          className="font-body text-[#2D2420] mt-6 md:mt-8 text-lg md:text-xl max-w-2xl drop-shadow-[0_2px_10px_rgba(253,250,246,0.75)]"
        >
      ...
      <motion.a
        ...
        className="absolute bottom-8 left-1/2 -translate-x-1/2 z-10 text-[#B07D62]"
      >
        <ChevronDown size={28} />
      </motion.a>
    </section>
