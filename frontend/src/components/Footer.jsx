      ...
      <div className="lux-container py-16 grid md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <div className="flex gap-4 mt-5 text-[#7A9E9C]">
            <a href="https://instagram.com" target="_blank" rel="noreferrer" className="hover:text-[#2A7E7C] transition-colors" data-testid="footer-instagram"><Instagram size={18} /></a>
            <a href="https://wa.me/911234567890" target="_blank" rel="noreferrer" className="hover:text-[#2A7E7C] transition-colors" data-testid="footer-whatsapp"><MessageCircle size={18} /></a>
          </div>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 font-body">
            <li className="flex items-center gap-3"><MessageCircle size={16} className="text-[#2A7E7C]" /> <span className="text-[#2A7E7C]">+91 98XXX XXXXX</span></li>
            ...
            <li className="flex items-center gap-3"><Instagram size={16} className="text-[#2A7E7C]" /> <span className="text-[#2A7E7C]">@dafruito</span></li>
          </ul>
        </div>
      </div>
